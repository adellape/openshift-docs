...
(one minor version at a time, e.g., 3.6 to 3.7) as well as between
xref:../../release_notes/ocp_3_7_release_notes.adoc#ocp-37-asynchronous-errata-updates[asynchronous errata updates] within a minor version (e.g., 3.7.z).
