...
[NOTE]
====
Operator SDK 1.3.0 supports Kubernetes 1.19.
====
...
==== OLM updated to use Kubernetes 1.20
...
See xref:../release_notes/versioning-policy.adoc#ocp-4-3-versioning-policy[OpenShift Container Platform Versioning Policy] for more specific details on backwards compatibility guarantees.
