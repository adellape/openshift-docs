...
- Operator that was previously installed with OLM by using the `run bundle` subcommand
- A later version of the same Operator packaged and pushed to a registry as a bundle image
