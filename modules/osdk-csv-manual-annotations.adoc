...
- `subscription-required`: Operators requires additional licenses or subscriptions not included in {product-title}. Relates to the `operators.openshift.io/valid-subscription` annotation.
